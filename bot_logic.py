...
# --- MENUS ---
MAIN_MENU = [
    [KeyboardButton("🧪 Laboratorios Prácticos"), KeyboardButton("🛒 Tienda / Recargas")],
    [KeyboardButton("⚙️ Mi Cuenta"), KeyboardButton("👥 Comunidad")],
    [KeyboardButton("🛠️ Tools"), KeyboardButton("🧹 Limpiar Chat")]
]
